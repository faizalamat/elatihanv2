    ...
    <tr>
        <td align="center" valign="top" bgcolor="#E2E2E2">
            ...
            <table width="990" border="0" cellspacing="0" cellpadding="3">
          	<form id="kursus" name="kursus" method="post" action="index.php?modul=laporan&amp;menu=bahagian">
              <tr bgcolor="#E2E2E2">
          ...
          <div align="right" class="text1">
			 ...
			 if (isset($_POST['Submit'])) {
				 ?>
	             [ <a href="export.php?menu=bahagian<?php if ($bahagian != "ALL") { echo "&bahagian=".$bahagian; } ?><?php if ($status != "ALL") { echo "&status=".$status; } ?><?php if ($bulan != "ALL") { echo "&bulan=".$bulan; } ?>&tahun=<?php echo $tahun; ?>">Export</a> ] 
             <?php
			 }
			 else {
				 ?>
	             [ <a href="export.php?menu=bahagian">Export</a> ] 
             <?php
			 }
			 ?>
          </div>
          ...
          <table width="990" border="1" cellspacing="0" cellpadding="3" style="border-collapse: collapse">
            <tr class="text2">
              <td colspan="8" align="center" bgcolor="#DE5302">LAPORAN MENGIKUT UNIT</td>
            </tr>
            <tr class="text1">
