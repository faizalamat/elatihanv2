    ...
    <tr>
        <td align="center" valign="top" bgcolor="#E2E2E2">
              ...
              <tr bgcolor="#E2E2E2">
                ...
                <td width="46" align="right"><select name="kategori" id="kategori">
				  ...
				  while ($ta = mysqli_fetch_array($da)) {
					  ...
					  if ($ta['tids'] == isset($_POST['kategori'])) { $select = 'selected="selected"'; }
					  else { $select = ""; }
					  ?>
          ...
          <table width="700" border="0" cellspacing="0" cellpadding="3">
            ...
            <tr class="text1">
              ...
              <td width="324" align="left" bgcolor="#CCCCCC">Kategori &amp; Tajuk EPSA</td>
              <td width="107" align="center" bgcolor="#CCCCCC">Kod EPSA</td>
              <td width="93" align="center" bgcolor="#CCCCCC">Jumlah Jam</td>
              <td width="107" align="center" bgcolor="#CCCCCC">Tindakan</td>
            </tr>
            <?php
			if ($kategori != "ALL") {
			...
			while ($t = mysqli_fetch_array($d)) {
        		...
        		<tr bgcolor="#FFFF00">
                  <td align="center">#</td>
                  <td colspan="3" align="left"><strong><?php echo output1($t['kategori']); ?></strong></td>
      ...
      <br />
            <table width="500" border="0" cellspacing="0" cellpadding="3">
          	<form id="epsa" name="epsa" method="post" action="index.php?modul=epsa&amp;menu=tambahk">
              <tr>
                <td colspan="2" align="center" bgcolor="#DE5302" class="text2">TAMBAH KATEGORI EPSA</td>
              </tr>
              <tr>
                <td width="96" align="right" bgcolor="#CCCCCC">Kategori EPSA <span class="text8">*</span> :</td>
                <td width="386" align="left"><input name="kategori" type="text" id="kategori" size="55" maxlength="255" class="input1" /></td>
              </tr>
              <tr>
                <td align="center" bgcolor="#CCCCCC">&nbsp;</td>
                <td align="left"><input type="submit" name="Submit" id="Submit" value="Simpan" class="button" />
            ...
            <br />
          <table width="500" border="0" cellspacing="0" cellpadding="3">
          	<form id="epsa" name="epsa" method="post" action="index.php?modul=epsa&amp;menu=tambah">
              <tr>
                <td colspan="2" align="center" bgcolor="#DE5302" class="text2">TAMBAH EPSA</td>
              </tr>
              <tr>
                ...
                <td align="left"><select name="kategori" id="kategori">
                  <?php
					...
					while ($ta = mysqli_fetch_array($da)) {
						?>
                  <option value="<?php echo $ta['tids']; ?>"><?php echo $ta['kategori']; ?></option>
                  <?php
					}
					?>
                </select></td>
              ...
              <tr>
                ...
                <td width="386" align="left"><input name="epsa" type="text" id="epsa" size="55" maxlength="255" class="input1" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td align="left"><input name="jam" type="text" id="jam" size="5" maxlength="255" class="input1" /> 
                  JAM</td>
              </tr>
              <tr>
                <td align="center" bgcolor="#CCCCCC">&nbsp;</td>
