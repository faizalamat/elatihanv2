        ...
        <td align="center" valign="top" bgcolor="#E2E2E2">
            ...
            <table width="688" border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                ...
                <td align="left" bgcolor="#FFFFFF"><input name="email" type="text" class="input1" id="email" size="20" maxlength="50"  /><span style="padding-left: 5px;"><b>@MKN.GOV.MY</b></span>
                  <!--<select name="domain" id="domain">
                    <option value="@1GOVUC.GOV.MY">@1GOVUC.GOV.MY</option>
					<option value="@PICC.GOV.MY">@PICC.GOV.MY</option>
                  </select> -->
