                    ...
                    <td height="146" align="center">
                        <table width="300" cellpadding="1" cellspacing="0" border="0">
                            ...
                            if (!empty($_SESSION['staff'])) {
                                ?>
                                    <?php //echo $_SESSION['staff'];
                                $q = "SELECT * FROM user WHERE unokp =  '" . input1($_SESSION['staff']) . "'
		                        ORDER BY unokp ASC";
                                $qlevel = mysqli_query($con,$q);
                                $tm = mysqli_fetch_array($qlevel);
                                    ?>
                                <tr>
                                    <td colspan="2" align="center">
										...
										if (isset($tm['ulevel']) == 1) { echo "<br>[ Super Admin ]"; }
										elseif (isset($tm['ulevel']) == 2) { echo "<br>[ Pentadbir ]"; }
										?>
                                    </td>
                                </tr>
                            <?php
